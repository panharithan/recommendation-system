...
$totalSubmissionsQuery =
    "SELECT COUNT(*) AS total FROM recommendation_requests";
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-primary">Admin Panel of Recommendation System</h2>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="update_user.php?id=<?= $row[
                                "id"
                            ] ?>" class="btn btn-sm btn-warning">Edit</a>
                            <a href="delete_user.php?id=<?= $row[
                                "id"
        ...
        <nav>
            <ul class="pagination justify-content-center">
                <li class="page-item <?= $page <= 1 ? "disabled" : "" ?>">
                    <a class="page-link" href="admin_dashboard.php?page=<?= $page -
                ...
                <?php endfor; ?>
                <li class="page-item <?= $page >= $totalPagesUsers
                    ? "disabled"
                    : "" ?>">
                    <a class="page-link" href="admin_dashboard.php?page=<?= $page +
                        1 ?>" aria-label="Next">
